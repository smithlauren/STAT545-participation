...
- <<Weak. The graphy doesn't show any types of errors which makes it hard to assess if the differences are actually significant. The data are visually skewed and it is hard to visualize the fact that the averages are not actually that far apart. We can't really assess if they are "more motivated".>>
